...
public class GenerarFlexyCup {
    ...
    public static void main(String[] args) {
        ...
        String path = "TrabajoCompiladores/src/archivos/lexico/lexico.flex";
        generarLexer(path);
        String[] param = new String[5];
        param[0] = "-destdir";
        param[1] = "TrabajoCompiladores/src/archivos/sintactico";
        param[2] = "-parser";
        param[3] = "MiParser";
        param[4] = "TrabajoCompiladores/src/archivos/sintactico/parser.cup";
        generarParser(param);
