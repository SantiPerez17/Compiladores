  ...
  public final java_cup.runtime.Symbol CUP$MiParser$do_action_part00000000(
    ...
    RESULT = ld + d ; 
        ...
        if(!tablaSimbolos2.containsKey("strmensaje3")){
            ArrayList<String> contenido = new ArrayList<>(Arrays.asList("STRING_LITERAL","CTE_STRING","La lista está vacía",String.valueOf(mensaje3.getValor().toString().length())));
        ...
        for (Expresion e : le) {
            Integer i = le.size();
            String a = i.toString();
            AND and_c = new AND("AND", Tipo.Bool, new Igual("Igual", Tipo.Bool, new Resta("Resta", Tipo.Int, new ConstanteEntera(a, Tipo.Int, "LenLista"), new Identificador("_Pivot"+CodeGeneratorHelper.getPivot(), Tipo.Int)), new Identificador("_IdPos"+CodeGeneratorHelper.getPos(), Tipo.Int)), new MenorOIgual("MenorOIgual", Tipo.Bool, new Identificador("_Pivot"+CodeGeneratorHelper.getPivot(), Tipo.Int), new ConstanteEntera(a, Tipo.Int, "LenLista")));
            Asignacion asig1 = new Asignacion("Asignacion", new Identificador("_Acum"+CodeGeneratorHelper.getAcum(), Tipo.Int), new Suma("Suma", Tipo.Int, new Identificador("_Acum"+CodeGeneratorHelper.getAcum(), Tipo.Int), e));
            Asignacion asig2 = new Asignacion("Asignacion", new Identificador("_IdPos"+CodeGeneratorHelper.getPos(), Tipo.Int), new Suma("Suma", Tipo.Int, new Identificador("_IdPos"+CodeGeneratorHelper.getPos(), Tipo.Int), new ConstanteEntera("1", Tipo.Int, "Constante_Entera")));
            Asignacion asig3 = new Asignacion("Asignacion", new Identificador("_Pivot" + CodeGeneratorHelper.getPivot(), Tipo.Int), new Resta("Resta", Tipo.Int, new Identificador("_Pivot"+ CodeGeneratorHelper.getPivot(), Tipo.Int), new ConstanteEntera("1", Tipo.Int, "Constante_Entera")));
            List<Sentencia> sentencias1 = new ArrayList<>();
            sentencias1.add(asig1);
            sentencias1.add(asig2);
            sentencias1.add(asig3);
            /*                                   */
            Asignacion asig4 = new Asignacion("Asignacion", new Identificador("_IdPos"+CodeGeneratorHelper.getPos(), Tipo.Int), new Suma("Suma", Tipo.Int, new Identificador("_IdPos"+CodeGeneratorHelper.getPos(), Tipo.Int), new ConstanteEntera("1", Tipo.Int, "Constante_Entera")));
        ...
        MayorOIgual lista_menos_elementos = new MayorOIgual("long_lista>=valorPivot", Tipo.Bool, new ConstanteEntera(long_lista, Tipo.Int, "longitud_lista"), new Identificador("_Pivot"+ CodeGeneratorHelper.getPivot(),Tipo.Int));
