...
class CUP$MiParser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$MiParser$do_action_part00000000(
    ...
    RESULT = ld + d ; 
        ...
        CodeGeneratorHelper.getNewAcum();
        CodeGeneratorHelper.getNewPos();
        ...
        for (Expresion e : le) {
            ...
            Asignacion asig1 = new Asignacion("Asignacion", new Identificador("_acum"+CodeGeneratorHelper.getAcum(), Tipo.Int), new Suma("Suma", Tipo.Int, new Identificador("acum"+CodeGeneratorHelper.getAcum(), Tipo.Int), e));
            ...
            Asignacion asig2 = new Asignacion("Asignacion", new Identificador("_ID_pos"+CodeGeneratorHelper.getPos(), Tipo.Int), new Suma("Suma", Tipo.Int, new Identificador("ID_pos"+CodeGeneratorHelper.getPos(), Tipo.Int), new ConstanteEntera("1", Tipo.Int, "Constante_Entera")));

            if(!tablaSimbolos2.containsKey("_ID_pos"+CodeGeneratorHelper.getPos())){
                ...
                simbolos.append(String.format("%20s%20s%20s%20s%20s%n", "_ID_pos"+ CodeGeneratorHelper.getPos(), contenidoPos.get(0), contenidoPos.get(1), contenidoPos.get(2), contenidoPos.get(3)));
            }
